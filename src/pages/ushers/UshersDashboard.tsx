...
export function UshersDashboard() {
  ...
  const ushersTeam = teams.find(t => t.team_type?.codigo === 'obreiros')
  ...
  if (!ushersTeam) {
    return (
      <EmptyState
        ...
        description="Nenhuma equipe de obreiros foi encontrada. Crie uma equipe primeiro."
      />
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Obreiros</h1>
          <p className="text-gray-600 mt-2">Gerencie as escalas de obreiros</p>
        </div>
        <Button
          className="flex items-center gap-2 bg-ushers hover:bg-ushers/90"
      ...
      <Card>
        ...
        <CardContent>
          {ushersTeam.members && ushersTeam.members.length > 0 ? (
            ...
            <EmptyState
              title="Sem membros"
              description="Adicione membros à equipe de obreiros"
              size="sm"
            />
          )}
        </CardContent>
