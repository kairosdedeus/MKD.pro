  ...
  if (!danceTeam) {
    return (
      <EmptyState
        ...
        description="Nenhuma equipe de dança foi encontrada. Crie uma equipe primeiro."
      />
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Dança</h1>
          <p className="text-gray-600 mt-2">Gerencie as escalas de dança</p>
        </div>
        <Button
          className="flex items-center gap-2 bg-dance hover:bg-dance/90"
      ...
      <Card>
        ...
        <CardContent>
          {danceTeam.members && danceTeam.members.length > 0 ? (
            ...
            <EmptyState
              title="Sem membros"
              description="Adicione membros à equipe de dança"
              size="sm"
            />
          )}
        </CardContent>
