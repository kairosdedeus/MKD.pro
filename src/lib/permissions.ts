...
export const isLeader = (profiles: Profile[], teamType?: TeamTypeCode): boolean => {
...
export const isMember = (profiles: Profile[], teamType: TeamTypeCode): boolean => {
...
export const getTeamPermissions = (
  ...
  const leader = teamType ? isLeader(profiles, teamType) || isTeamLeader : false
...
export const getSchedulePermissions = (
  ...
  const gerencial = isGerencial(profiles)
  const canEdit = canEditSchedule(profiles, teamType, isTeamLeader, isTeamMember)
