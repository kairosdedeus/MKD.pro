...
import {
  LayoutDashboard, UsersRound, UserPlus, Music2, Menu, X,
} from 'lucide-react'
import { cn } from '@/lib/utils'
import { Button } from '@/components/ui/button'
import { useAuthStore } from '@/stores/authStore'
import { useTeams } from '@/hooks/useTeams'
import { TEAM_TYPE_ICONS, TEAM_TYPE_LABELS, TEAM_TYPE_ROUTES } from '@/lib/team-flow'
            ...
            <div className="space-y-0.5">
              {ministryItems.map(item => (
                ...
                >
                  ...
                  <span className="text-[10px] text-muted-foreground">{item.teams.length}</span>
                </NavLink>
              ))}
            </div>
          </div>
